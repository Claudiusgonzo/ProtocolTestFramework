...
namespace Microsoft.Protocols.TestTools.Messages.Runtime
{
    ...
    public class EventQueue
    {
        ...
        /// <summary>
        /// Gets or sets the timeout value which is to be used when expecting events.
        ...
        /// An assertion failure is raised to the test suite if any of the expected event does not occur after timeout.
        /// </summary>
        ...
        public int ExpectOneOf<T1, T2>(EventInfo info1, T1 handler1, EventInfo info2, T2 handler2)
        {
            ...
            {
                host.Assert(false, string.Format("did not receive expected event '{0}' or '{1}' after waiting '{2}'; queue: {3}",
